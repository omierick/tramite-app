...
doc.text(`Lugar: ${lugar}  Día: ${dia}  Mes: ${mes}  Año: ${anio}`, 107, y + 8);
...
salto(14);
  ...
  doc.setFontSize(9);
  doc.text("EL/LA QUE SUSCRIBE BAJO PROTESTA DE DECIR VERDAD, MANIFIESTO QUE LOS DATOS AQUÍ PROPORCIONADOS...", 15, y, { maxWidth: 180 });
  salto(10);
