...
export const generatePDF = (tramite) => {
  ...
  if (tramite.tipo === "Autorización de Lotificación") {
    ...
    // ¡AQUÍ AGREGA EL FOLIO!
    doc.setFontSize(12);
    doc.setFont("helvetica", "");
    doc.text(`Folio: ${tramite.folio || tramite.id || "No asignado"}`, 105, y, {
      align: "center",
    });
    salto(8);
    ...
    doc.setFontSize(9);
    doc.text(
      "EL/LA QUE SUSCRIBE BAJO PROTESTA DE DECIR VERDAD, MANIFIESTO QUE LOS DATOS AQUÍ PROPORCIONADOS, SON VERDADEROS...",
      15,
      y,
      { maxWidth: 180 }
    );
